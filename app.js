...
function seedMockData() {
  ...
  const mockTxs = [
    // --- JUNE (m6) ---
    { id: generateId(), date: `${m6}-01`, profile: 'Personal', type: 'income', category: 'Salary', amount: 85000.00, counterparty: 'Tata Consultancy Services', description: 'Monthly salary credit', account: 'Bank' },
    { id: generateId(), date: `${m6}-05`, profile: 'Personal', type: 'expense', category: 'Rent & Maid Salary', amount: 20000.00, counterparty: 'Imperial Heights Owner', description: 'Apartment rent', account: 'Bank' },
    { id: generateId(), date: `${m6}-08`, profile: 'Personal', type: 'expense', category: 'Food & Dining', amount: 540.00, counterparty: 'Swiggy Delivery', description: 'Biryani order', account: 'Cash' },
    { id: generateId(), date: `${m6}-12`, profile: 'Personal', type: 'purchase', category: 'Electronics', amount: 24999.00, counterparty: 'Croma Retail', description: 'New office monitor', account: 'Bank' },
    { id: generateId(), date: `${m6}-15`, profile: 'Shared / Family', type: 'expense', category: 'Bills & Utilities', amount: 4500.00, counterparty: 'Tata Power Co.', description: 'Electricity bill', account: 'Bank' },
    { id: generateId(), date: `${m6}-18`, profile: 'Personal', type: 'donation', category: 'Charity & Goodwill', amount: 1500.00, counterparty: 'Goonj NGO', description: 'Monsoon relief donation', account: 'Reserved' },
    { id: generateId(), date: `${m6}-22`, profile: 'Personal', type: 'lend', category: 'Friend Loan', amount: 3000.00, counterparty: 'Rahul Sharma', description: 'Lent for concert tickets', account: 'Cash' },
    { id: generateId(), date: `${m6}-28`, profile: 'Personal', type: 'expense', category: 'Bills & Utilities', amount: 650.00, counterparty: 'Netflix & Spotify', description: 'Monthly subscription', account: 'Bank' },
    
    // --- JULY (m7) ---
    { id: generateId(), date: `${m7}-01`, profile: 'Personal', type: 'income', category: 'Salary', amount: 85000.00, counterparty: 'Tata Consultancy Services', description: 'Monthly salary credit', account: 'Bank' },
    { id: generateId(), date: `${m7}-03`, profile: 'Personal', type: 'income', category: 'Freelance & Business', amount: 15500.00, counterparty: 'Design Project Client', description: 'Logo redesign invoice', account: 'Investments' },
    { id: generateId(), date: `${m7}-05`, profile: 'Personal', type: 'expense', category: 'Rent & Maid Salary', amount: 20000.00, counterparty: 'Imperial Heights Owner', description: 'Apartment rent', account: 'Bank' },
    { id: generateId(), date: `${m7}-06`, profile: 'Personal', type: 'expense', category: 'Food & Dining', amount: 3240.00, counterparty: 'Blinkit Delivery', description: 'Weekly groceries', account: 'Cash' },
    { id: generateId(), date: `${m7}-10`, profile: 'Shared / Family', type: 'expense', category: 'Food & Dining', amount: 1850.00, counterparty: 'Barbeque Nation', description: 'Family celebration dinner', account: 'Cash' },
    { id: generateId(), date: `${m7}-12`, profile: 'Personal', type: 'borrow', category: 'Family Debt', amount: 5000.00, counterparty: 'Uncle Ramesh', description: 'Borrowed for car repair excess', account: 'Cash' },
    { id: generateId(), date: `${m7}-15`, profile: 'Shared / Family', type: 'expense', category: 'Bills & Utilities', amount: 999.00, counterparty: 'Airtel Broadband', description: 'Wifi internet bill', account: 'Bank' },
    { id: generateId(), date: `${m7}-20`, profile: 'Personal', type: 'donation', category: 'Religious / Temple', amount: 2100.00, counterparty: 'Siddhivinayak Temple Trust', description: 'Annual donation', account: 'Reserved' },
    { id: generateId(), date: `${m7}-22`, profile: 'Personal', type: 'income', category: 'Refunds & Cashback', amount: 3000.00, counterparty: 'Rahul Sharma', description: 'Rahul paid back the loan', account: 'Cash' },
    
    // --- AUGUST (m8) ---
    { id: generateId(), date: `${m8}-01`, profile: 'Personal', type: 'income', category: 'Salary', amount: 85000.00, counterparty: 'Tata Consultancy Services', description: 'Monthly salary credit', account: 'Bank' },
    { id: generateId(), date: `${m8}-02`, profile: 'Personal', type: 'expense', category: 'Rent & Maid Salary', amount: 20000.00, counterparty: 'Imperial Heights Owner', description: 'Apartment rent', account: 'Bank' },
    { id: generateId(), date: `${m8}-04`, profile: 'Personal', type: 'expense', category: 'Food & Dining', amount: 2450.00, counterparty: 'Instamart Delivery', description: 'Groceries', account: 'Cash' },
    { id: generateId(), date: `${m8}-06`, profile: 'Personal', type: 'expense', category: 'Transport & Fuel', amount: 850.00, counterparty: 'Ola Cabs', description: 'Weekend travel', account: 'Cash' },
    { id: generateId(), date: `${m8}-08`, profile: 'Shared / Family', type: 'expense', category: 'Food & Dining', amount: 2200.00, counterparty: 'PVR Cinemas', description: 'Movie tickets & snacks', account: 'Cash' },
    { id: generateId(), date: `${m8}-10`, profile: 'Personal', type: 'lend', category: 'Friend Loan', amount: 5000.00, counterparty: 'Priya Nair', description: 'Lent for certification course fee', account: 'Bank' },
    { id: generateId(), date: `${m8}-12`, profile: 'Personal', type: 'purchase', category: 'Apparel', amount: 3500.00, counterparty: 'Myntra Store', description: 'Running shoes & jacket', account: 'Bank' },
    { id: generateId(), date: `${m8}-14`, profile: 'Personal', type: 'donation', category: 'Charity & Goodwill', amount: 500.00, counterparty: 'GiveIndia Foundation', description: 'Monthly support donation', account: 'Reserved' }
  ];
...
function switchTab(tabId) {
  ...
  // Update nav active classes for both sidebar and mobile bottom nav
...
function populateProfileSelectors() {
  ...
  const headerPSelect = document.getElementById('header-profile-selector');
  ...
  // Active Profile Selector in Header Mobile
  if (headerPSelect) {
    headerPSelect.innerHTML = state.profiles.map(p => `<option value="${p}" ${p === state.currentProfile ? 'selected' : ''}>${p}</option>`).join('');
  }
...
function setupProfileActions() {
  ...
  // Change Profile Event (Sidebar)
  if (pSelect) {
    pSelect.addEventListener('change', handleProfileChange);
  }

  // Change Profile Event (Header Mobile)
  if (headerPSelect) {
    headerPSelect.addEventListener('change', handleProfileChange);
  }
...
window.editTransaction = function(id) {
  ...
  const modalAccountSelect = document.getElementById('modal-account');
  if (modalAccountSelect) {
    modalAccountSelect.value = tx.account || 'Bank';
  }
  ...
  profileTxs.forEach(t => {
    ...
    if (t.type === 'income' || t.type === 'borrow') {
      if (accountBalances[acc] !== undefined) {
        accountBalances[acc] += t.amount;
      }
    } else if (t.type === 'expense' || t.type === 'purchase' || t.type === 'donation' || t.type === 'lend') {
      if (accountBalances[acc] !== undefined) {
        accountBalances[acc] -= t.amount;
      }
    }
  ...
  if (accountsListEl) {
    accountsListEl.innerHTML = `
      <div class="account-item">
        <div class="account-icon bank"><i data-lucide="landmark"></i></div>
        <div class="account-info">
          <span class="account-name">Bank Account</span>
          <span class="account-val">${formatCurrency(accountBalances.Bank)}</span>
        </div>
      </div>
      <div class="account-item">
        <div class="account-icon cash"><i data-lucide="banknote"></i></div>
        <div class="account-info">
          <span class="account-name">Cash Wallet</span>
          <span class="account-val">${formatCurrency(accountBalances.Cash)}</span>
        </div>
      </div>
      <div class="account-item">
        <div class="account-icon invest"><i data-lucide="trending-up"></i></div>
        <div class="account-info">
          <span class="account-name">Investments</span>
          <span class="account-val">${formatCurrency(accountBalances.Investments)}</span>
        </div>
      </div>
      <div class="account-item">
        <div class="account-icon reserve"><i data-lucide="lock"></i></div>
        <div class="account-info">
          <span class="account-name">Reserved / Savings</span>
          <span class="account-val">${formatCurrency(accountBalances.Reserved)}</span>
        </div>
      </div>
    `;
  }
      ...
      recentTbody.innerHTML = sortedTxs.map(t => {
        ...
        return `
          <tr>
            ...
            <td>
              <span class="table-category">${t.category}</span>
              <div class="text-secondary font-small" style="margin-top: 4px; display: flex; align-items: center; gap: 4px;">
                <i data-lucide="${t.account === 'Cash' ? 'banknote' : t.account === 'Investments' ? 'trending-up' : t.account === 'Reserved' ? 'lock' : 'landmark'}" style="width:12px; height:12px;"></i>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Mobile Central Add Button and Settings gear wiring
  const mobileAddBtn = document.getElementById('mobile-nav-add-btn');
  const desktopAddBtn = document.getElementById('btn-new-transaction');
